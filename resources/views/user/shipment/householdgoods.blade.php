...
@section('body')
 ...
 {!! Form::open(array('url'=>'householdgoods','class'=>'form-horizontal','id'=>'vehicle_form','files' => true)) !!}
...
<div class="clearfix"></div>
                    <div class="_inner_ads_d">
                        <h4>Additional Details <span class="pull-right"><i class="fa fa-plus" onclick="fun_plus()"></i> <i class="fa fa-minus" onclick="fun_minus()"></i></span></h4>
                        

                       
                           <i class="fa fa-chevron-up pull-right" aria-hidden="true" onclick="$('._inner_d_txt').slideToggle();('.fa').toggleClass('fa-chevron-down')"></i> 
                        ...
                        <br>
                         ...
                         <a href="{{ url('subCategory/2') }}" class="btn btn-border">Back</a>

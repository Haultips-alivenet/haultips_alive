            ...
            <div class="activity_box activity_box1">
                ...
                <div class="scrollbar _scrollbar" id="style-2">
                    ...
                    <div class="activity-row activity-row1">
                        <div class="col-xs-3 col-md-3 activity-img"><img src="{{asset('public/uploads/userimages/'.$value->image)}}" class="img-responsive" width="60px" height="80px" alt=""><span>{{date('h:sa',strtotime($value->created_at))}}</span></div>
                    ...
                    <div class="activity-row activity-row1">
                        ...
                        <div class="col-xs-3 activity-img"><img src="{{asset('public/uploads/userimages/'.$profile_pic->image)}}" class="img-responsive" width="60px" height="80px" alt=""><span>{{date('h:sa',strtotime($value->created_at))}}</span></div>
                        <div class="clearfix"> </div>
                    </div>
                    <?php } ?>

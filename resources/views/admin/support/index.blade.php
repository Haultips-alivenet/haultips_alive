...
@section('body')
   <div id="page-wrapper">
        <div class="graphs">
            <h3 class="blank1">Support</h3>
                <div class="xs tabls">
                    <div class="panel panel-warning" >
                        
                                {!! Form::open(array('url'=>'admin/supportList','id'=>'menu','method'=>'get')) !!}
                                    <div class="row">  
                                        ...
                                        <div class="form-group col-sm-3">
                                            ...
                                            <a href="{{ url('admin/supportList') }}" class="btn btn-success" title="Refresh"><i class="fa fa-refresh"></i></a>                                            
                                        </div>                                        
                                    </div>
                                    {!! Form::close() !!}
                                        ...
                                        @foreach($users as $user)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a onclick="return confirm('Do you Want to Delete Support ?');return false;" href="{{URL :: asset('admin/support/'.$user->id)}}/delete" class="btn btn-success" title='delete'><i class="fa fa-trash-o"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @else

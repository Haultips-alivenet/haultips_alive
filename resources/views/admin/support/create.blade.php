...
@section('body')
    <div id="page-wrapper">
        <div class="graphs">
            <h3 class="blank1">New Support</h3>
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                        {!! Form::open(array('url'=>'admin/support/store','class'=>'form-horizontal','id'=>'newUser')) !!}
                            
                            <div id="msgStatus"></div>
                             <div class="form-group" style="display:none">
                                     {!! Form :: text('userType','4',['class'=>'form-control1', 'id'=>'userType'])  !!}                                                              
                            </div>
				...
				<div class="col-sm-8">	
                            ...
                            {!! Form :: submit("Save Support",["class"=>"btn-success btn",'id'=>'user']) !!}
                            </div>
                        {!! Form::close() !!}
...
<script>
    ...
    $.validator.addMethod("uniqueMobile", function(value, element) {
        ...
        "Support Mobile Number is Already Taken"
    );

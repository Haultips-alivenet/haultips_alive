...
@section('body')
    <div id="page-wrapper">
        <div class="graphs">
            <h3 class="blank1">Update Support</h3>
                <div class="tab-content">
                    ...
                    <div class="tab-pane active" id="horizontal-form">
                        {!! Form::model($user,['route'=>['admin.support.update',$user->id], 'method'=>'patch','class'=>'form-horizontal'])  !!}
				...
				<div class="col-sm-8">	
                            ...
                            {!! Form :: submit("Update Support",["class"=>"btn-success btn",'id'=>'user']) !!}
                            </div>
                        {!! Form::close() !!}
